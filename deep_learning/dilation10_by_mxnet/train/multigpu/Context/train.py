...
def main():
    ...
    model = mx.model.FeedForward(ctx=ctx, symbol=softmax, num_epoch=args.epoches, optimizer='sgd',initializer=Identity(args.std), arg_params=arg_params, begin_epoch=0, learning_rate=args.lr, momentum=args.momentum, wd=args.wd, lr_scheduler=lr_scheduler)
